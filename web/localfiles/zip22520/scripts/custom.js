$(document).ready(function () {       
    ...
    setTimeout(function() {
        var swiper_store_slider = new Swiper('.store-slider', {autoplay:2500});
        var swiper_store_slider2 = new Swiper('.store-slider-2', {autoplay:2500});
        var swiper_single = new Swiper('.single-item', {autoplay:2500});
        var swiper_text = new Swiper('.text-slider', {autoplay:2500});
        var swiper_news_slider = new Swiper('.news-slider');
        var swiper_home_slider = new Swiper('.homepage-slider', {autoplay:0});
        var swiper_quote_slider = new Swiper('.quote-slider', {autoplay:2500});
        var swiper_coverpage = new Swiper('.coverpage-slider', {autoplay:2500});
